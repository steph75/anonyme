<?php
/**
 * anonyme functions and definitions
 *
 * @package anonyme
 */
...
if ( ! function_exists( 'anonyme_setup' ) ) :
/**
 ...
 */
function anonyme_setup() {

	/*
	 * Make theme available for translation.
	 * Translations can be filed in the /languages/ directory.
	 * If you're building a theme based on anonyme, use a find and replace
	 * to change 'anonyme' to the name of your theme in all the template files
	 */
	load_theme_textdomain( 'anonyme', get_template_directory() . '/languages' );
	...
	register_nav_menus( array(
		'primary' => __( 'Primary Menu', 'anonyme' ),
	) );
	...
	add_theme_support( 'custom-background', apply_filters( 'anonyme_custom_background_args', array(
		'default-color' => 'ffffff',
		'default-image' => '',
	) ) );
}
endif; // anonyme_setup
add_action( 'after_setup_theme', 'anonyme_setup' );

/**
 * Register widgetized area and update sidebar with default widgets.
 */
function anonyme_widgets_init() {
	register_sidebar( array(
		'name'          => __( 'Sidebar', 'anonyme' ),
		'id'            => 'sidebar-1',
...
add_action( 'widgets_init', 'anonyme_widgets_init' );
...
add_action( 'wp_enqueue_scripts', 'anonyme_scripts' );
